export let menu = 
    [
        { 
            label: 'Main', 
            i18n: 'Default.main.menu.main', 
            icon: 'pi pi-fw pi-home', 
            to: '/', 
            authrity: 'CURD', 
            ord: 1,
            items: [
                { label: 'Dashboard', icon: 'pi pi-fw pi-list', to: '/', authrity: 'CURD', ord: 1 },
            ],
        },
        {
            label: 'Basic',
...
export const menuSamples = 
    [
        { 
            ...
            i18n: 'Samples.main.menu.Dashboard', 
            icon: 'pi pi-fw pi-home', 
            ord: 1,
            items: [
                { label: 'Dashboard', icon: 'pi pi-fw pi-pencil', to: '/samples', authrity: 'CURD', ord: 1 },
            ]
        },
        {
            ...
            items: [
                ...
                { label: 'menus', icon: 'pi pi-fw pi-circle-off', to: '/samples/menu/payment', authrity: 'CURD', ord: 16 },
            ],
        },
        {
        ...
        { 
            ...
            ord: 2,
            items: [
                { label: 'Documentation', icon: 'pi pi-fw pi-list', to: '/samples/documentation', authrity: 'CURD', ord: 1 },
            ],
